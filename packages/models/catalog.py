...
def get_default_registry() -> ModelRegistry:
    ...
    models: list[ModelMetadata] = [
        ...
        ModelMetadata(
            ...
            license_type=LicenseType.PROPRIETARY,
            quantization="Cloud API",
            capabilities=["chat", "stream", "reasoning", "coding", "fast_inference"],
            description="DeepSeek V4 Flash served with accelerated throughput on NVIDIA NIM infrastructure.",
        ),
        ModelMetadata(
            model_id="moonshotai/kimi-k2.6",
            name="Kimi k2.6 (NVIDIA NIM)",
            organization="Moonshot AI / NVIDIA",
            provider="nvidia",
            architecture="Moonshot Multimodal Transformer",
            parameter_count=0,
            context_length=128_000,
            ...
            license_type=LicenseType.PROPRIETARY,
            quantization="Cloud API",
            capabilities=["chat", "stream", "long_context", "multilingual"],
            description="Moonshot AI Kimi k2.6 served via NVIDIA NIM cloud inference.",
        ),
        ModelMetadata(
